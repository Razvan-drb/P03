...
class TestTournamentRun:
    ...
    def test_add_players(self, four_players, default_tournament):
        """test add 4 players"""
    ...
    def test_round_computed(self, last_tournament):
        ...
        round_objects = [Round.search(i) for i in last_tournament.round_id_list]
    ...
    # def test_get_results(self, four_players, last_tournament):
